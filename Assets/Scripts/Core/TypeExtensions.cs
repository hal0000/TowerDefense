...
namespace TowerDefense.Core
{
    public static class TypeExtensions
    {
        ...
        public static int ToInt(this object o)
        {
            ...
            double.TryParse(o.ToString(), NumberStyles.Any, CultureInfo.InvariantCulture, out double d);
            return (int)d;
        }
        ...
        public static int ToInt(this object o, string key)
        {
            ...
            return dict.TryGetValue(key, out object value) ? value.ToInt() : 0;
        }
        ...
        public static float ToFloat(this object o)
        {
            ...
            float.TryParse(o.ToString(), NumberStyles.Any, CultureInfo.InvariantCulture, out float fVal);
            return fVal;
        }
        ...
        public static float ToFloat(this object o, string key)
        {
            ...
            return dict.TryGetValue(key, out object value) ? value.ToFloat() : 0f;
        }
        ...
        public static long ToLong(this object o)
        {
            ...
            if (o is long l) return l;
            long.TryParse(o.ToString(), NumberStyles.Any, CultureInfo.InvariantCulture, out long lVal);
            return lVal;
        }
        ...
        {
            if (o is not IDictionary<string, object> dict) return 0;
            return dict.TryGetValue(key, out object value) ? value.ToLong() : 0;
        }
        ...
        public static double ToDouble(this object o)
        {
            ...
            double.TryParse(o.ToString(), NumberStyles.Any, CultureInfo.InvariantCulture, out double dVal);
            return dVal;
        }
        ...
        {
            if (o is not IDictionary<string, object> dict) return 0;
            return dict.TryGetValue(key, out object value) ? value.ToDouble() : 0;
        }
        ...
        public static bool ToBool(this object o, string key)
        {
            ...
            return dict.TryGetValue(key, out object value) && value.ToBool();
        }
        ...
        {
            dict.TryGetValue(key, out object value);
            List<object> objList = value as List<object> ?? new List<object>();
