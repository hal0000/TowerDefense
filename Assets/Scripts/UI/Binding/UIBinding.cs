...
namespace TowerDefense.UI.Binding
{
    ...
    public abstract class UIBinding : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Comma-separated list of Context.PropertyName")] 
        [SerializeField]
        ...
        /// </summary>
        [Tooltip("Index for ListBinding items. Set to -1 for direct property binding.")]
        [SerializeField]
            ...
            try
            {
                for (int i = 0; i < c; i++)
                {
                    ...
                    if (bindable != null)
                    {
                        ...
                        if (valueProperty != null)
                        {
                            arr[i] = valueProperty.GetValue(bindable);
                        }
                    }
                }
        ...
        protected void PushValue<T>(int bindingIndex, T newValue)
        {
            ...
            if (bindable != null)
            {
                ...
                if (valueProperty != null)
                {
                    valueProperty.SetValue(bindable, newValue);
                }
            }
        }
